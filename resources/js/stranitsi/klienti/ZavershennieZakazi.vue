...
export default {
  ...
  components: {Pagination, QTableExtended, DataOrFallback, OrdersTable},
  ...
  methods: {
    ...
    async loadOrders() {
      ...
      const {data} = await servicePolzovatelei().poluchitZavershennieZakaziKlientov(customer_id, this.getOrderOptions());
